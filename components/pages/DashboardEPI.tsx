...
function pct(a:number, b:number){ if(b<=0) return 0; return Math.max(0, Math.min(100, (a/b)*100)) }
...
export default function DashboardEPI(){
  ...
  useEffect(()=>{
    ...
    fetch(`/api/dashboard/metrics?`+params.toString())
      .then(r=>r.json()).then(setData).catch(()=>setData(undefined))
        ...
        <main className="grow">
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="grid grid-cols-12 gap-6">
              ...
              <div className="col-span-12 md:col-span-6 lg:col-span-4">
                <div className="bg-white dark:bg-gray-800 shadow rounded-2xl p-4">
                  ...
                  <div className="h-44">
                    ...
                    }} width={389} height={160} cutout='70%' />
                  </div>
              ...
              <div className="col-span-12 md:col-span-6 lg:col-span-4">
                <div className="bg-white dark:bg-gray-800 shadow rounded-2xl p-4">
                  ...
                  <div className="h-44">
                    <DoughnutChart data={{
                      labels: ['Realizado','Restante'],
                      datasets: [{ data: [anuPct, 100-anuPct], borderWidth: 0 }]
                    }} width={389} height={160} cutout='70%' />
                  </div>
              ...
              <div className="col-span-12 lg:col-span-4">
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-4">
                  <div className="flex justify-between items-center">
                    <div className="font-semibold">Top itens do mês</div>
                  </div>
              ...
              {/* Série temporal: entregas e itens (12m) */}
              ...
              {/* Alertas: Estoque baixo + Pendências vencidas */}

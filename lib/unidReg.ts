// Auto-generated: Unidade -> Regional mapping and helpers (v8)
...
export function canonUnidade(s: string | null | undefined): string {
  ...
  const norm = up.replace(/\s+/g,' ').replace(/\s-\s/g,'-').trim();
  return norm;
}
...
export const UNID_TO_REGIONAL: Record<string, Regional> = {
  ...
  "SHOPPING DA CRIANCA": "NORTE",
  "SOLAR DO OUTONO": "NORTE",
  "SVO -SERV. VERIFICACAO DE OBITOS-SAO LUIS": "NORTE",
  "SVO -SERV. VERIFICACAO DE OBITOS-TIMON": "LESTE",
  "SVO -SERV.VERIFICACAO DE OBITOS-IMPERATRIZ": "SUL",

...
export default function Page() {
  const LS_ALTERDATA_ROWS='alt_rows'; const LS_ALTERDATA_COLS='alt_cols'; const LS_ALTERDATA_BATCH='alt_batch';
const [columns, setColumns] = useState<string[]>(()=>{ try{ return JSON.parse(localStorage.getItem(LS_ALTERDATA_COLS)||'[]')||[] }catch{return []} });
  const [rows, setRows] = useState<AnyRow[]>(()=>{ try{ return JSON.parse(localStorage.getItem(LS_ALTERDATA_ROWS)||'[]')||[] }catch{return []} });

  ...
  return (
    <div className="space-y-4">
      <div className="rounded-xl border border-border bg-panel p-6 shadow-sm">
        <h1 className="text-2xl font-semibold mb-1">Acidentes de trabalho</h1>
        <p className="text-sm text-muted">Registro, análise e acompanhamento de acidentes de trabalho nas unidades da EMSERH.</p>
      </div>

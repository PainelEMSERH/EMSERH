  ...
  return (
    <div className="space-y-4">
      <div className="rounded-xl border border-border bg-panel p-6 shadow-sm">
        <h1 className="text-2xl font-semibold mb-1">Ordens de Serviço</h1>
        <p className="text-sm text-muted">Cadastro e acompanhamento de Ordens de Serviço de Segurança do Trabalho.</p>
      </div>

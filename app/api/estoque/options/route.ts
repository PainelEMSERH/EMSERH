...
export async function GET() {
  try {
    ...
    const colRegional = pick(['regional','regiao','regional_nome','regiao_nome','nome_regional','regional_responsavel']);
    const colUnidade  = pick(['unidade','unidade_nome','nome_unidade','nmddepartamento','nmedepartamento']);
